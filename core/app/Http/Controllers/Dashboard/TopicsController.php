...
class TopicsController extends Controller
{
    ...
    public function store(Request $request, $webmasterId)
    {
        ...
        if (!empty($WebmasterSection)) {
            ...
            $formFileName1 = "photo_file_banner";
            $fileFinalName1 = "";
            if ($request->$formFileName1 != "") {
                ...
                // resize & optimize
                Helper::imageResize($path . $fileFinalName1);
                Helper::imageOptimize($path . $fileFinalName1);
            }
            ...
            if ($fileFinalName1 != "") {
                $Topic->photo_file_banner = $fileFinalName1;
            }
    ...
    public function update(Request $request, $webmasterId, $id)
    {
        ...
        if (!empty($WebmasterSection)) {
            ...
            if (!empty($Topic)) {
                ...
                if ($request->$formFileName1 != "") {
                    // Delete a Topic photo
                    if ($Topic->$formFileName1 != "" && $Topic->$formFileName1 != "default.png") {
                        File::delete($this->uploadPath . $Topic->$formFileName1);
                    }
                ...
                if ($request->photo_banner_delete == 1) {
                    // Delete photo_file
                    if ($Topic->photo_file_banner != "" && $Topic->photo_file_banner != "default.png") {
                        File::delete($this->uploadPath . $Topic->photo_file_banner);
                    }
