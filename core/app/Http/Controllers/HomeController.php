...
class HomeController extends Controller
{
    ...
    public function post_page($lang, $Topic = [], $private_topic_view = 0)
    {
        if (!empty($Topic)) {
            ...
            if (!empty($WebmasterSection)) {
                ...
                if($Topic->seo_url_slug_en == 'about-us')
                {
                    $view = "about";
                }
                if($Topic->seo_url_slug_en == 'contact')
                {
                    $view = "contact";
                }
    ...
    public function contact_submit(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            return redirect()->back()->with('msg', __('backend.submitDone'));
        }
    ...
    public function projects()
    {
        ...
        $data = array();
        $data['sections'] = Section::where('webmaster_id', '=', 8)->where('father_id', '=', '0')->get();
        
        return view("frontEnd.projects", ["page_data" => $data]);
    }
