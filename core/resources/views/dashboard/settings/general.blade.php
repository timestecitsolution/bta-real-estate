    ...
    <div class="p-a-md col-md-12">
        ...
        @foreach(Helper::languagesList() as $ActiveLanguage)
            <div class="form-group">
                ...
                {!! Form::textarea('site_desc_'.@$ActiveLanguage->code,$Setting->{'site_desc_'.@$ActiveLanguage->code}, array('placeholder' => '','class' => 'form-control','maxlength'=>300, 'dir'=>@$ActiveLanguage->direction,'rows'=>'2')) !!}
            </div>
        @endforeach
        @foreach(Helper::languagesList() as $ActiveLanguage)
            <div class="form-group">
