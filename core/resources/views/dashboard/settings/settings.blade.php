        ...
        <div class="row-col">
                ...
                <div class="p-y">
                    <div class="nav-active-border left b-primary">
                        <ul class="nav nav-sm">
                            ...
                            <li class="nav-item">
                                <a class="nav-link block {{  ( Session::get('active_tab') == 'homeTab') ? 'active' : '' }}"
                                   href="#"
                                   data-toggle="tab" data-target="#tab-8"
                                   onclick="document.getElementById('active_tab').value='homeTab'"><i
                                        class="material-icons">&#xe86f;</i>
                                    &nbsp; {!!  __('backend.home') !!}</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link block {{  ( Session::get('active_tab') == 'aboutTab') ? 'active' : '' }}"
                                   href="#"
                                   data-toggle="tab" data-target="#tab-9"
                                   onclick="document.getElementById('active_tab').value='aboutTab'"><i
                                        class="material-icons">&#xe8c6;</i>
                                    &nbsp; About</a>
                            </li>
            ...
            <div class="col-sm-7 col-lg-10 light lt">
                ...
                <div class="tab-content">
                    ...
                    @include('dashboard.settings.home')
                    @include('dashboard.settings.about')
                </div>
                {{Form::close()}}
            </div>
        </div>
