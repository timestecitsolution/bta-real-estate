            ...
            locale:'{{ @Helper::currentLanguage()->code }}'
                  ...
                  <span class="fa fa-calendar"></span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {!! Form::text('address',$Topic->address, array('placeholder' => 'Address','class' => 'form-control', 'dir'=>'ltr')) !!}
                            </div>
                        </div>
                        ...
                        @if($WebmasterSection->photo_status)
                            <div class="form-group row">
                                <label for="photo_file_banner"
                                       class="col-sm-2 form-control-label">Banner Photo</label>
                                <div class="col-sm-10">
                                    @if($Topic->photo_file_banner!="")
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div id="topic_photo" class="col-sm-4 box p-a-xs">
                                                    <a target="_blank"
                                                       href="{{ asset('uploads/topics/'.$Topic->photo_file_banner) }}"><img
                                                            src="{{ asset('uploads/topics/'.$Topic->photo_file_banner) }}"
                                                            class="img-responsive">
                                                        {{ $Topic->photo_file_banner }}
                                                    </a>
                                                    <br>
                                                    <a onclick="document.getElementById('topic_photo').style.display='none';document.getElementById('photo_banner_delete').value='1';document.getElementById('undo').style.display='block';"
                                                       class="btn btn-sm btn-default">{!!  __('backend.delete') !!}</a>
                                                </div>
                                                <div id="undo" class="col-sm-4 p-a-xs" style="display: none">
                                                    <a onclick="document.getElementById('topic_photo').style.display='block';document.getElementById('photo_banner_delete').value='0';document.getElementById('undo').style.display='none';">
                                                        <i class="material-icons">
                                                            &#xe166;</i> {!!  __('backend.undoDelete') !!}</a>
                                                </div>

                                                {!! Form::hidden('photo_banner_delete','0', array('id'=>'photo_banner_delete')) !!}
                                            </div>
                                        </div>
                                    @endif

                                    {!! Form::file('photo_file_banner', array('class' => 'form-control','id'=>'photo_file_banner','accept'=>'image/*')) !!}
