...
<header class="text-white">
      ...
      <div class="container d-flex justify-content-between align-items-center">
        <a class="navbar-brand d-none d-lg-block" href="{{ Helper::homeURL() }}">
          @if(Helper::GeneralSiteSettings("style_logo_" . @Helper::currentLanguage()->code) != "")
            ...
            <img src="{{ URL::to('uploads/settings/'.Helper::GeneralSiteSettings("style_logo_" .
              @Helper::currentLanguage()->code)) }}" alt="Desktop Logo">
          @else
            <img alt="{{ Helper::GeneralSiteSettings(" site_title_" . @Helper::currentLanguage()->code) }}"
            src="{{ URL::to('uploads/settings/nologo.png') }}" class="img-fluid" width="172" height="50">
          @endif
        ...
        <div class="hero-banner-content ps-0 ps-lg-5">
          <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center d-none d-lg-block">
              <img src="{{ URL::to('uploads/settings/' . Helper::GeneralSiteSettings("banner_image")) }}" class="img-fluid"
                alt="Building">
            </div>
          </div>
        </div>
  ...
  @elseif($slug == 'details')
    ...
    <section class="project-banner">
      <div class="container">
        <img style="display:none;" src="{{ URL::to('uploads/topics/' . $page_data['photo_file_banner']) }}" alt=""
          width="100%">
