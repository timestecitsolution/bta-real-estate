        ...
        <div class="modal-content" id="printArea{{ $price->id }}">
            ...
            <div class="modal-body">
                <!-- Company Header -->
                 <div class="row">
                    <div class="col-8 mb-1">
                        ...
                        <p class="mb-0"><b>Address:</b> Missionpara, Narayanganj</p>
                        <p class="mb-0"><b>Phone:</b> +880 1234 567 890</p>
                        <p class="mb-0"><b>Email:</b> info@bta.com</p>                        
                    </div>
                    <div class="col-4 test-end">
                        <h5>Bill To:</h5>
                        ...
                        <p class="mb-0">Flat Size: {{ $price->flat_size ?? 'N/A' }} sqft</p>
                         <small>Booking Date: {{ $price->created_at?->format('d M Y') ?? 'N/A' }}</small><br>
                ...
                <table class="table table-bordered mt-3">
                    <thead class="table-light">
                        <tr>
                            <th colspan="4" class="text-center">Additional Charges & Facilities</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td>{{ number_format($price->gas_amount, 2) ?? 'Already Paid' }} Tk</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <th>Parking Fee</th>
                            <td>{{ number_format($price->parking_amount, 2) ?? 'Already Paid' }} Tk</td>
                        </tr>
                        <tr>
                            <th>Utility</th>
                            <td>{{ $price->is_utility_included == 1 ? 'Included' : 'Not Included' }}</td>

                            <th>Utility Charge</th>
                            <td>{{ number_format($price->utility_amount, 2) ?? 'Already Paid' }} Tk</td>
                        </tr>
